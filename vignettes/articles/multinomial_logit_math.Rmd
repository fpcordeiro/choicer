...
The per-individual score accumulated inside `mnl_bhhh_parallel` is **weight-free**, so the
two summed matrices are obtained from the existing exports evaluated at $\hat\theta$:
