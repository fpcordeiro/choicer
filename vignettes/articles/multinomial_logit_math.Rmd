...
*Code reference: `mnl_bhhh_parallel()` in [src/mnlogit.cpp](../src/mnlogit.cpp); `compute_sandwich_vcov()` and `.sandwich_combine()` in [R/classes.R](../R/classes.R); `wesml_weights()` / `sample_by_choice()` in [R/sampling.R](../R/sampling.R).*
