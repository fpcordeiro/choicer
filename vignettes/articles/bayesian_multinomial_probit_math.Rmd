...
Defaults: $\bar{\beta} = 0$, $A = 0.01\, I_K$, $\nu = p + 3$, $V = \nu I_p$ — proper raw-scale priors, with prior mean of $\Sigma$ close to $I_p$. They should be treated as defaults to interrogate, not as evidence that the induced identified-scale prior is weak. Sensitivity is most important for covariance, correlation, and substitution conclusions when alternative-specific identifying variation is limited.
