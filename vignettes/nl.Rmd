...
economic rationale; report every lambda estimate and uncertainty interval;
identify singleton nests, whose dissimilarity parameter has no within-nest
variation to learn from; and flag estimates outside the conventional random-
utility range `0 < lambda <= 1`. Refit plausible alternative trees and compare
fit, diversion, elasticities, WTP, and welfare—not just the coefficient table.

When using `blp()`, report convergence and sensitivity to damping. Damping is a
numerical aid, not evidence for the tree or the economic validity of lambda. NL
