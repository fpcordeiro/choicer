...
regressors (prices, distances, attributes that differ across the options within
a choice situation) are the exclusion restrictions that identify $\Sigma$ in
practice; the simulated data above contain two of them. The Bayesian machinery
...
stronger standard is several chains from dispersed starting values, compared
